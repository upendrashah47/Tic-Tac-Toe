...
/**
 * Created by hardikjani on 1/16/17.
 */
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.print(LocalStorageProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.print(LocalStorageProvider.class.getSimpleName(), "Error writing thumbnail" + e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.print(LocalStorageProvider.class.getSimpleName(), "Error closing thumbnail" + e);
                }
        }
